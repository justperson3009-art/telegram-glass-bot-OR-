...
CATEGORIES = {
    ...
    "parts": {
        ...
        "label": "Запчасти",
        "active": True,
        "hint": "Напишите модель телефона или название запчасти, и я подберу совместимые запчасти.\n\n💰 Цены ориентировочные\n\nПримеры: `iPhone 15 динамик`, `Samsung A54 камера`, `кнопка Redmi Note 12`"
    },
    "display": {
        "emoji": "🖥️",
        "label": "Дисплеи",
        "active": True,
        "hint": "Напишите модель телефона, и я подберу совместимые дисплеи.\n\n💰 Цены ориентировочные (topset-minsk.by)\n\nПримеры: `iPhone 15`, `Samsung A32`, `Redmi Note 12`"
    },
    "battery": {
        "emoji": "🔋",
        "label": "АКБ",
        "active": True,
        "hint": "Напишите модель телефона, и я подберу совместимые АКБ.\n\n💰 Цены ориентировочные\n\nПримеры: `iPhone 15`, `Samsung A55`"
    }
}

# === Валюты и курсы ===
# Базовая валюта прайса: BYN (белорусский рубль)
# Курсы обновляются автоматически из API НБРБ
CURRENCIES = {
    "BYN": {"symbol": "BYN", "label": "Белорусский рубль", "rate": 1.0},  # Базовая
    "USD": {"symbol": "$", "label": "Доллар США", "rate": None},  # Обновляется из API
    "RUB": {"symbol": "₽", "label": "Российский рубль", "rate": None},  # Обновляется из API
}

# Файл для хранения курсов валют
CURRENCY_RATES_FILE = os.path.join(os.path.dirname(os.path.abspath(__file__)), "currency_rates.json")
