...
CATEGORIES = {
    ...
    "case": {
        ...
        "label": "Чехлы",
        "active": True,
        "hint": "Напишите модель телефона, и я подберу совместимые чехлы.\n\nПримеры: `iPhone 15`, `Samsung A55`, `Redmi Note 13`"
    },
    "display": {
        "emoji": "🖥️",
        "label": "Дисплеи",
    ...
    "oca": {
        ...
        "active": True,
        "hint": "Напишите модель телефона, и я подберу стёкла для переклейки (сепарации).\n\nПримеры: `iPhone 15`, `Samsung S24`"
    }
}
